...
class Network:
    ...
    def __init__(self):
        ...
        self.questions = [
            ...
            'Correlation of Prestige of Institutes and Number of Publications in Premium Venues',
        ...
        for i in range(len(conferences)):
            for j in range(len(conferences)):
                if G.number_of_edges(conferences[i], conferences[j]) > 0:
                    G2.add_edge(conferences[i], conferences[j], weight=G.number_of_edges(
